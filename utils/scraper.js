...
var WebScraper = (module.exports = function(options) {
  if (options == null) {
    options = {};
  }
...
WebScraper.prototype.getScrapedData = function(params, callback) {
  var self = this;
...
WebScraper.prototype.extractData = function(html, limit, callback) {
  var scraped_data = [];
  var $ = cheerio.load(html);
  var links = $("td.featured")
    .children("a")
    .slice(0, limit);
...
*/
WebScraper.prototype.getSERPScrapedData = function(params, callback) {
  var self = this;
  var limit;
  var params = params || {};
 ...
 */
WebScraper.prototype.extractSERPData = function(html, limit, callback) {
  var parsedResult = [];
  $ = cheerio.load(html);
  $("div.narrow")
    .slice(0, limit)
...
WebScraper.prototype.getHtml = function(url, params, callback) {
  var self = this;
